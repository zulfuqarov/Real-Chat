...
const ChatRoom = () => {
    ...
    if (loading) {
        return (
            <div className='flex justify-center items-center w-[70%] h-[100vh]' role="status ">
            ...
            <div className="flex-1 ">
                <div>
                    <header className="bg-white p-4 text-gray-700 flex justify-between items-center">
                        ...
                        {
                            enteredRoom ? <button className='w-[100px] h-[35px] text-[18px] font-semibold text-white bg-red-600 rounded-md ' onClick={leavRoom}>Leav room</button> : <button className='w-[100px] h-[35px] bg-blue-600 text-[18px] font-semibold rounded-md text-white' onClick={enterRoom}>Join</button>
                        }
                    </header>
                    {
